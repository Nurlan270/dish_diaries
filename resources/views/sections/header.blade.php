    ...
    <nav class="bg-white border-gray-200 dark:bg-gray-900">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto py-4 px-2 sm:p-4">
            ...
            <div class="flex md:order-2">
                ...
                @guest
                    <livewire:partials.theme-toggler/>
                    <x-locale-switcher/>
                @endguest
                ...
                @auth
                    ...
                    <div>
                        <div id="create-recipe-modal" tabindex="-1" aria-hidden="true"
                            ...
                            <div class="relative p-4 w-full max-w-xl max-h-full">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white flex space-x-2 items-center">
                                            <x-akar-reciept class="w-7 h-auto"/>
                                            <span>{{ __('recipe-modal.title') }}</span>
                                        </h3>
                                        <button type="button"
                                                class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                data-modal-toggle="create-recipe-modal">
                                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w.org/2000/svg"
                                                 fill="none"
                                                 viewBox="0 0 14 14">
                    ...
                    <div id="dropdownAvatar"
                        ...
                        <div class="flex p-2 items-center justify-between">
                            ...
                            <div class="flex gap-x-1">
                                <form id="{{ getOppositeLocale() }}-switcher" action="{{ route('locale.switch', ['locale' => getOppositeLocale()]) }}"
